...
public class SplashScreen implements Screen {
    ...
    private Stage stage;
    private SpaceRace game;private SpaceRace pause;
    ...
    public SplashScreen(SpaceRace game) {
        ...
        //Todo:ejercicio 2.1 asignamos un nuevo título
        textStyle = new Label.LabelStyle(AssetManager.font, null);
        textLbl = new Label("Monster green", textStyle);
        ...
        Actions mayor=new Actions();


        // Afegim les accions de escalar: primer es fa gran i després torna a l'estat original ininterrompudament

        container.addAction(Actions.repeat(RepeatAction.FOREVER, Actions.sequence(Actions.scaleTo(1.5f, 1.5f, 1),
                Actions.scaleTo(1, 1, 1))));
        //TODO: ejercicio 2.1 titulo que desaparece y aparece a la vez que hace escala:
        container.addAction(Actions.repeat(RepeatAction.FOREVER, Actions.sequence(Actions.alpha(1,1),
                Actions.alpha(0,1))));
